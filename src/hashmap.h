 ...
 */
HASH_MAP_API Hashmap *hashmapCreate(size_t initialCapacity,
                                    size_t (*hash)(void *key), bool (*equals)(void *keyA, void *keyB));

/**
 * Frees the hash map. Does not free the keys or values themselves.
 */
HASH_MAP_API void hashmapFree(Hashmap *map);

/**
 * Hashes the memory pointed to by key with the given size. Useful for
 * implementing hash functions.
 */
HASH_MAP_API int hashmapHash(void *key, size_t keySize);
 ...
 */
HASH_MAP_API void *hashmapPut(Hashmap *map, void *key, void *value);

/**
 * Gets a value from the map. Returns NULL if no entry for the given key is
 * found or if the value itself is NULL.
 */
HASH_MAP_API void *hashmapGet(Hashmap *map, void *key);

/**
 * Returns true if the map contains an entry for the given key.
 */
HASH_MAP_API bool hashmapContainsKey(Hashmap *map, void *key);
 ...
 */
HASH_MAP_API void *hashmapMemoize(Hashmap *map, void *key,
 ...
 * entry was present.
 */
HASH_MAP_API void *hashmapRemove(Hashmap *map, void *key);

/**
 * Gets the number of entries in this map.
 */
HASH_MAP_API size_t hashmapSize(Hashmap *map);

/**
 * Invokes the given callback on each entry in the map. Stops iterating if
 * the callback returns false.
 */
HASH_MAP_API void hashmapForEach(Hashmap *map,
 ...
 */
HASH_MAP_API void hashmapLock(Hashmap *map);

/**
 * Unlocks the hash map so other threads can access it.
 */
HASH_MAP_API void hashmapUnlock(Hashmap *map);
 ...
 */
HASH_MAP_API int hashmapIntHash(void *key);

/**
 * Compares two int keys for equality.
 */
HASH_MAP_API bool hashmapIntEquals(void *keyA, void *keyB);
 ...
 */
HASH_MAP_API size_t hashmapCurrentCapacity(Hashmap *map);

/**
 * Counts the number of entry collisions.
 */
HASH_MAP_API size_t hashmapCountCollisions(Hashmap *map);
