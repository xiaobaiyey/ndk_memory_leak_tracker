...
function(git_clone)
    ...
    if(EXISTS ${${SOURCE_DIR}})
        ...
        execute_process(
                ...
                RESULT_VARIABLE     git_result
                OUTPUT_VARIABLE     git_output)
        message(STATUS "${GIT_EXECUTABLE} clone ${PARGS_GIT_URL} --recursive ${${SOURCE_DIR}}")
        if(NOT git_result EQUAL "0")
            set(${CLONE_RESULT} FALSE CACHE INTERNAL "" FORCE)
            if(NOT PARGS_QUIET)
                message(WARNING "${PARGS_PROJECT_NAME} clone error:${git_output} code:${git_result}")  #ToDo: maybe FATAL_ERROR?
            endif()
            return()
        endif()        
    endif()
